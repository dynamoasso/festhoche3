...
async function processAllImages(options = {}) {
  ...
  // Compress Johann's DVR images
  console.log('\nCompressing Johann\'s DVR images...');
  await compressImages(
    path.join(__dirname, '..', 'public', 'gallery', 'johann', 'dvr'),
  ...
  // Compress Johann's Banquet images
  console.log('\nCompressing Johann\'s Banquet images...');
  await compressImages(
    path.join(__dirname, '..', 'public', 'gallery', 'johann', 'banquet'),
  ...
  // Compress Alicja's Claquettes images
  console.log('\nCompressing Alicja\'s Claquettes images...');
  await compressImages(
    path.join(__dirname, '..', 'public', 'gallery', 'alicja', 'claquettes'),
